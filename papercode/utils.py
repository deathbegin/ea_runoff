...
def get_basin_list(basin_list) -> List:
    ...
    # basin_file = Path(__file__).absolute().parent.parent / f"data/4huc/{basin_list}.txt"
    basin_file = Path(__file__).absolute().parent.parent / f"data/kfold/{basin_list}.txt"
